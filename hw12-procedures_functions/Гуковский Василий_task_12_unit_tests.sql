...
begin
  v_payment_id := create_payment(p_payment_detail => v_payment_detail,p_summa => 150000,p_currency_id => 643);
...
select * from payment_detail pd  where pd.payment_id = 41 order by pd.field_id;
